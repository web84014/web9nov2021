        ...
        <div class="dl_addons_row">
            <div class="dl_col_lg_12">
                <div class="dl_single_library_box">
                    ...
                    <p class="description"><?php echo esc_html_e('Get additional features and widgets with the premium version of the plugin. Turn on automatic updates from the WordPress dashboard and enjoy updates without any hassle.', 'droit-addons'); ?></p>
